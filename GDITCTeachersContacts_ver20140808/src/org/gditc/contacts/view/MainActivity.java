...
public class MainActivity extends ExpandableListActivity {
	...
	private void initPopupWindow() {
		...
		btnSystemContact = (Button) view.findViewById(R.id.btnSystemContacts);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		ExpandableListContextMenuInfo menInfo = (ExpandableListContextMenuInfo) menuInfo;
		int type = ExpandableListView.getPackedPositionType(menInfo.packedPosition);
		// 在组上长按 
		if (type == ExpandableListView.PACKED_POSITION_TYPE_GROUP) {
			// 获取组上的标题以作为上下文菜单的标题
			String title = ((TextView) menInfo.targetView.findViewById(R.id.groupName))
					.getText().toString();
			...
			// 获取联系人的名称以作为上下文菜单的标题
			String title = ((TextView) menInfo.targetView.findViewById(R.id.name))
					.getText().toString();
			Drawable icon = ((ImageView) menInfo.targetView.findViewById(R.id.contactIcon))
					.getDrawable();
